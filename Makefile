...
libs/pcl: libs
	([ -d $@ ] && echo $@ exist) || git clone https://github.com/PointCloudLibrary/pcl.git 
	@echo Done $@ !!

libs/pcl2: libs
	([ -d $@ ] && echo $@ exist) || git clone https://github.com/PointCloudLibrary/pcl2.git
	@echo Done $@ !!
...
git-create:
	...
	git remote add origin https://github.com/duongbaoduy/pcl-exp.git
	@echo Done $@ : $^ !!
